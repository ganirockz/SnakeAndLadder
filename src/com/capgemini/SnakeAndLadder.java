...
public class SnakeAndLadder {
	...
	public static void main(String[] args) {
		...
		if(position1 == 100) {
			System.out.println("The player1 win and he turned dice :"+number_of_turns_of_1+" times");
		}
		else {
			System.out.println("The player2 win and he turned dice :"+number_of_turns_of_2+" times");
		}
	}
